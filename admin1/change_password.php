...
if(isset($_POST['ok']))
{
                            ...
                            mysql_select_db("online_edu",$con);
                            $email=$_POST['email'];
                                 $pwd=$_POST['pwd'];
                            $new_pwd=$_POST['new_pwd'];
                            
                       
                            $q=mysql_query("select * from admin where email='$email' and pwd='$pwd'")or die(mysql_error());
                            $a=mysql_fetch_array($q);
                            if($a>0)
                            {
                                mysql_query("update admin set pwd='$new_pwd' where email='$email'")or die(mysql_error());
                                ?>
                               <script>
